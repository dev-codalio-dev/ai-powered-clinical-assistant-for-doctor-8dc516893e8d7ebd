const api = {
    ...
    "schemas": {
      ...
      "call_recording": {
        "x-rhino-model": {
          ...
          "modelPlural": "call_recordings",
          "name": "callRecording",
          "pluralName": "callRecordings",
          "readableName": "Call recording",
          "pluralReadableName": "Call recordings",
          "ownedBy": "patient",
          "singular": false,
          "path": "/api/call_recordings",
          "searchable": false
        },
        "type": "object",
        "properties": {
      ...
      "transcript": {
        "x-rhino-model": {
          "model": "transcript",
          "modelPlural": "transcripts",
          "name": "transcript",
          "pluralName": "transcripts",
          "readableName": "Transcript",
          "pluralReadableName": "Transcripts",
          "ownedBy": "call_recording",
          "singular": false,
  ...
  "paths": {
    ...
    "/api/call_recordings": {
      "get": {
        "operationId": "call_recording-index",
        "parameters": [
      ...
      "post": {
        "operationId": "call_recording-create",
        "parameters": [
    ...
    "/api/call_recordings/:id": {
      "get": {
        "operationId": "call_recording-show",
        "parameters": [
          {
            "name": "id",
            "in": "path",
      ...
      "patch": {
        "operationId": "call_recording-update",
        "parameters": [
          {
            "name": "id",
            "in": "path",
      ...
      "delete": {
        "operationId": "call_recording-destroy",
        "parameters": [
          {
            "name": "id",
            "in": "path",
    ...
    "/api/transcripts/:id": {
      ...
      "delete": {
        "operationId": "transcript-destroy",
        "parameters": [
          {
            "name": "id",
            "in": "path",
